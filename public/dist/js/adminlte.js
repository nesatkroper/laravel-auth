    ...
    class PushMenu {
        ...
        addSidebarBreakPoint() {
            ...
            const sidebarExpandList =
                (_b =
                    (_a = document.querySelector(SELECTOR_SIDEBAR_EXPAND)) ===
                        null || _a === void 0
                        ? void 0
...
const btnAddClose = document.getElementById("btn-add-close");
ElementById("btn-add-close");
ElementById("btn-add-close");
ElementById("btn-add-close");
let addModal = document.getElementById("custom-modal-add");
...
btnProduct.addEventListener("click", function () {
    ...
    productPage.classList.add("opacity-25");
});

btnProClose.addEventListener("click", function () {
    customModal.classList.remove("d-block");
    customModal.classList.add("d-none");
    productPage.classList.remove("opacity-25");
});

btnAdd.addEventListener("click", function () {
    addModal.classList.remove("d-none");
    addModal.classList.add("d-block");
    productPage.classList.add("opacity-25");
});

btnAddClose.addEventListener("click", function () {
    addModal.classList.remove("d-block");
